...
public sealed class NProgramInstallerConsoleSystem : SharedNProgramInstallerConsoleSystem
{
    ...
    {
        /*
        SubscribeLocalEvent<NProgramInstallerConsoleComponent, RecordModifiedEvent>(UpdateUserInterface);
        SubscribeLocalEvent<NProgramInstallerConsoleComponent, AfterGeneralRecordCreatedEvent>(UpdateUserInterface); */

        Subs.BuiEvents<NProgramInstallerConsoleComponent>(NProgramInstallerConsoleKey.Key, subs =>
        {
            /*
...
/*
    private void UpdateUserInterface<T>(Entity<NProgramInstallerConsoleComponent> ent, ref T args)
    {
        // TODO: this is probably wasteful, maybe better to send a message to modify the exact state?
        UpdateUserInterface(ent);
    }

    private void OnKeySelected(Entity<NProgramInstallerConsoleComponent> ent, ref SelectStationRecord msg)
    {
    ...
    private void OnFiltersChanged(Entity<NProgramInstallerConsoleComponent> ent, ref SetStationRecordFilter msg)
    {
    ...
    private void OnChangeStatus(Entity<NProgramInstallerConsoleComponent> ent, ref CriminalRecordChangeStatus msg)
    {
    ...
    */
    private void UpdateUserInterface(Entity<NProgramInstallerConsoleComponent> ent)
    {
        var (uid, console) = ent;
        ...
        {
            _ui.SetUiState(uid, NProgramInstallerConsoleKey.Key, new NProgramInstallerConsoleState());
            return;
        }

        // var listing = _records.BuildListing((owningStation.Value, stationRecords), console.Filter);

        /* var state = new NProgramInstallerConsoleState(listing, console.Filter);
        ...
        _ui.SetUiState(uid, NProgramInstallerConsoleKey.Key, state); */
    } /*
