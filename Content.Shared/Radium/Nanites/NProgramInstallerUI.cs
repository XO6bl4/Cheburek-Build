...
/// </summary>
[Serializable, NetSerializable]
public sealed class NProgramInstallerConsoleState : BoundUserInterfaceState
{
    /// <summary>
    ...
    public NProgramInstallerConsoleState(Dictionary<uint, string>? recordListing, StationRecordsFilter? newFilter)
    {
    ...
    /// </summary>
    public NProgramInstallerConsoleState() : this(null, null)
    {
    }
...
public sealed class CriminalRecordChangeStatus : BoundUserInterfaceMessage
{
    ...
    public NProgramInstallerConsoleStatus(SecurityStatus status, string? reason)
    {
        Status = status;
        Reason = reason;
    }
