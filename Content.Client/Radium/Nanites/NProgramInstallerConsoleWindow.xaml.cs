...
using Content.Shared.CriminalRecords; // todo: make shared nanites
...
public sealed partial class NProgramInstallerConsoleWindow : FancyWindow
{
    ...
    public NProgramInstallerConsoleWindow(EntityUid console,
        uint maxLength,
    ...
    public void UpdateState(NProgramInstallerConsoleState state)
    {
