...
public sealed class NProgramInstallerConsoleBoundUserInterface : BoundUserInterface
{
    ...
    private NProgramInstallerConsoleWindow? _window;
//    private ProgramWindow? _historyWindow; // todo: implement

    public NProgramInstallerConsoleBoundUserInterface(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    ...
    protected override void UpdateState(BoundUserInterfaceState state)
    {
        ...
        if (state is not NProgramInstallerConsoleState cast)
            return;
